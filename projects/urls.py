...
urlpatterns = [
    ...
    path('api/<int:project_id>/skills/add/', views.SkillAddView.as_view(), name='skill_add'),
    
    # API для удаления навыка из проекта
    path('api/<int:project_id>/skills/<int:skill_id>/remove/', views.SkillRemoveView.as_view(), name='skill_remove'),
